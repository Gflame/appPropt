...
export default class example extends Component {
    ...
    _verifyCode = () => {
        ...
        const user_object = {
            phone: phoneNumber,
            verifyID: res.body.data.verificationID,
            verifyCode: this.refs.form.getValues(),
        };
        ...
        setTimeout(async () => {
            try {
                const res = await api.put('sms_login_code/login', {
                    body: {
                        verificationId:user_object.verifyID,
                        verificationCode:user_object.verifyCode,
                        userPhone:user_object.phone
                    }
                });
